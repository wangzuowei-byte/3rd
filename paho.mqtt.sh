...
TOOLCHAINS_PATH=/toolchains/armhf_none_9.2_2019.12 

PTHREAD_NAME=paho.mqtt.c_source
TAR_NAME=paho.mqtt.c.tar.gz
...
function x86_build()
{
   ...
   # download and unzip
   mqtt_unzip ${WORKSPACE_PATH}/${TAR_NAME} ${TAR_BUILD_PATH}/${PTHREAD_NAME}
...
function aarch64_qnx710_build()
{
   ...
   # download and unzip
   freetype_unzip ${WORKSPACE_PATH}/${TAR_NAME} ${TAR_BUILD_PATH}/${PTHREAD_NAME}
