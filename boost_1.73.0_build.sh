...
function arm32_linux_build()
{
   ...
   # source env
   source ${TOOLCHAIN_PATH}/setup.sh
#--with-sysroot=/toolchains/armhf_none_9.2_2019.12/gcc-arm-9.2-2019.12-x86_64-arm-none-linux-gnueabihf/arm-none-linux-gnueabihf
...
function aarch64_qnx710_build()
{
   ...
   sed -i "105s/^/###&/g" ${PRJ_BUILD_PATH}/libs/stacktrace/build/Jamfile.v2 && \
